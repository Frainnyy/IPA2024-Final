#######################################################################################
# Yourname: Piraporn Prasert
# Your student ID: 65070157
# Your GitHub Repo: https://github.com/Frainnyy/IPA2024-Final.git
...
roomIdToGetMessages = (
    "Y2lzY29zcGFyazovL3VybjpURUFNOnVzLXdlc3QtMl9yL1JPT00vMDQzMzkzMjAtNWU5ZC0xMWVmLWI0MTUtZWQ5NGJjZjg4YjM4"
)
...
while True:
    ...
    #  e.g.  "/66070123 create"
    if message.startswith("/65070157"):
...
# --------------------------------------
        if command == "showrun" and responseMessage == 'ok':
            config_data = restconf_final.showrun()
            filename = "showrun.txt"  # กำหนดชื่อไฟล์
            with open(filename, "w") as file:
                file.write(config_data)

            fileobject = open(filename, "rb")  # เปิดไฟล์ในโหมดอ่านแบบไบต์
            filetype = "text/plain"
            postData = {
                "roomId": roomIdToGetMessages,
                "text": "show running config",
